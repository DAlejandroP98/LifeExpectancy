    ...
    .on('mouseover', function(e, d){
        ...
        <div class="image-container"> <!-- Agregamos una clase al contenedor -->
            <div class="image-info">
                <img src="/Actividad1_Esfera/assets/men.png" alt="Icono de hombre" width="60" height="60">
                <div>${Men}</div>
                <div><n>Men</n> </div>
            </div>
            <div class="image-info">
                <img src="/Actividad1_Esfera/assets/women.png" alt="Icono de mujer" width="60" height="60">
                <div>${Women}</div>
                <div><n>Women</n> </div>
            </div>
        </div>
